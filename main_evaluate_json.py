...
parser.add_argument('--save-prefix=ICDAR_json/meals', type=str, default='test', help='prefix for load ckpt model') # modify this
...
parser.add_argument('--e_ckpt_path', type=str, default='..\\graph\\CUTIE\\log\\') # modify this
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        ...
        try:
            ...
            ckpt_path = '..\\CutieMLproject\\graph\\SROIE'

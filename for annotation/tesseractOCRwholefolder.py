...
def main():
    ...
    a_directory = r"C:\Users\georgiev\PycharmProjects\CutieMLproject\goldstandart"
    for img in os.listdir(a_directory):
        ...
        new_doc.update({"global_attributes": {"file_id": img}})

        json_obj = json.dump(new_doc, img, indent=4, ensure_ascii=False)

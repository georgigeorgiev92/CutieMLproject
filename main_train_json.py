...
# #parser.add_argument('--ckpt_path', type=str, default='../graph/CUTIE/log/TEST/CUTIE2_dilate')
# parser.add_argument('--ckpt_path', type=str, default='..\\graph\\CUTIE\\log\\TEST\\CUTIE2_dilate')
# parser.add_argument('--ckpt_file', type=str, default='inception_resnet_v2_2016_08_30.ckpt')
...
parser.add_argument('--load_dict_from_path', type=str, default='dict/test') # 40000 or 20000TC or
